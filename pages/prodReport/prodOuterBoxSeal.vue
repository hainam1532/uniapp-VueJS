	...
	<view class="h-screen w-full bg-gradient-to-b from-blue-200 via-blue-100 to-white flex flex-col">
		<view class="flex flex-col bg-[#407bff] rounded-b-3xl gap-4 p-2">
			<view class="mx-2 flex justify-between">
				...
				<span class="font-semibold text-white py-1">Phát tem niêm phong thùng ngoài</span>
		...
		<scroll-view
			...
			scroll-y="true" 
			class="bg-[#f3f8fe] rounded-t-2xl shadow-lg size-full mx-auto shadow-lg p-2 scroll-container"
...
<script>
	...
	export default {
		...
		methods: {
			...
			toCreatePage() {
				uni.navigateTo({
					url: '/pages/prodReport/insertProd/insertOuterBoxSeal'
				})
			},
			onSearchChange() {
